...
class tblsupplyer(models.Model):
    ...
    commune = models.ForeignKey(tblcommunce, on_delete=models.SET_NULL, null=True, blank=True,related_name='commune',to_field='uniqid')
    village = models.ForeignKey(tblvillages, on_delete=models.SET_NULL, null=True, blank=True,related_name='village',to_field='uniqid')
    image = models.ImageField(default='user.png', upload_to='supplyer',null=True,blank=True)
